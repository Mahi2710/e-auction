...
String sql ="select * from railwat";
...
<form action="railwayclientdetails.jsp" method="post">
<td><input type="text" id="select" name="item" value="<%=resultSet.getString("item") %>"hidden/></td>
