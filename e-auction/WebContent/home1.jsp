		...
		<div class="col-md-4">
			<div class="card">
    			...
    			<p class="card-text">The Railway </p>
   				 <a href="raiwaydetail.jsp" class="btn primary-background1 text-white"> <span class="fa fa-train"></span>  Visit</a>
   				 </div>
			</div>
		</div>
				<div class="col-md-4">
			<div class="card">
    			...
    			<p class="card-text">The Bank</p>
   				 <a href="bankdetail.jsp" class="btn primary-background1 text-white"><span class="fa fa-bank"></span>  Visit</a>
   				 </div>
			</div>
		</div>
				<div class="col-md-4">
			<div class="card">
    			...
    			<p class="card-text">The Forest</p>
   				 <a href="forestdetail.jsp" class="btn primary-background1 text-white"><span class="fa fa-tree"></span>  Visit</a>
   				 </div>
			</div>
		</div>
	</div>
